                        ...
                        <ul class="todo-list ui-sortable">
                            @foreach($tasks as $task)
                                <li class="{{ $task->done ? 'done':'todo' }}" data-id-task="{{ $task->id }}">
                                    ...
                                    <img src="{{asset('/storage/' .  $task->image)}}" class="image_task"
                                         alt="Task image">
                                    <small
                                        class="label {{ isset($task->category) ? 'label-success' : 'label-warning' }}">{{ isset($task->category) ? $task->category->name : 'None'}}</small>
                                    <div class="tools">
